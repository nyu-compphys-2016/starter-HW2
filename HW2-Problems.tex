...
Write python functions to calculate integrals using the (right-biased) Riemann Sum, Trapezoid Rule, Simpson's Rule, and Romberg integration.  Test your methods using the following integrals:
\begin{align}
...
\begin{itemize}
	...
	\item Look in detail at the convergence of Romberg Integration. Does it converge as a power law at all? Discuss.
\end{itemize}
